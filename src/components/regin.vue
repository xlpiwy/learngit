  ...
  <el-main>
    ...
    <h3>用户注册</h3>
      ...
      <el-form-item prop="email">
        <el-input type="email" v-model="ReginForm.email" placeholder="邮箱"></el-input>
      </el-form-item>
      <el-form-item prop="tel">
        <el-input type="tel" v-model="ReginForm.tel" placeholder="手机号码"></el-input>
      </el-form-item>
...
export default {
  data () {
    let confirmpasswordCheck = (role, value, callback) => {
      if (value === '') {
    ...
    let telCheck = (role, value, callback) => {
      if (value === '') {
